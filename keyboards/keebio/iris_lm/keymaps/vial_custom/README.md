...
- toggle: the `RGB_LYR` keycode (`QK_KB_0`), currently mapped on FN2 top-left
...
| keymap itself | edit in vial GUI; save layout to `keebio-iris-lm.vil`; run the `keyb:qmk-rgb` agent; run `python3 tools/check_vil_keymap_sync.py` from repo root |
